...
subtitle: "a collection of my data visualizations and analyses"
format:
  html:
    toc: false
---
...
![](tidytuesdays/rolling_stone.png){fig-align="right" width="80%"}
...
![](tidytuesdays/mr_trash_wheel.png){fig-align="left" width="80%"}
...
![](tidytuesdays/doctor_who.png){fig-align="right" width="80%"}
...
![](tidytuesdays/taylor_swift.png){fig-align="left" width="80%"}
...
![](tidytuesdays/sf_rentals.png){fig-align="right" width="80%"}
